...
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36mTHE SILENT HACKER RAJ 🚭\e[93m/ \e[100;92https://youtube.com/@cyber_shr\e[0m"
echo
...
sed -e "s/\CYBER-SHR/$name/g" . CYBE-SHR.zsh-theme > $HOME/.oh-my-zsh/themes/CYBER-SHR.zsh-theme
